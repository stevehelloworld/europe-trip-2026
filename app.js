...
(function () {
  ...
  const CHECKLIST = [
    ...
    { id: "p2_insurance", p: "P2", cat: { zh: "保險裝備", en: "Gear" },
      zh: "旅行保險（醫療＋行李；e-Visa 保險已另有）",
      en: "Travel insurance (medical + bags; e-Visa insurance already purchased)",
      when: { zh: "出發前 7 天", en: "By 7 days before" }, note: { zh: "e-Visa 保險在 06_簽證與保險/", en: "e-Visa policy in folder 06" } },
    ...
    { id: "p2_offline", p: "P2", cat: { zh: "文件", en: "Files" },
      zh: "機票／住宿／郵輪／門票／e-Visa PDF 離線備份",
      en: "Offline PDFs: flights, hotels, cruise, tickets, e-Visa",
